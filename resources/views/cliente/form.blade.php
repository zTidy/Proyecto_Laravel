<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            <label for="fech_nacimiento" class="form-label">{{ __('Fech Nacimiento') }}</label>
            <input type="date" name="fech_nacimiento" class="form-control @error('fech_nacimiento') is-invalid @enderror" value="{{ old('fech_nacimiento', $cliente?->fech_nacimiento) }}" id="fech_nacimiento" placeholder="Fech Nacimiento">
            {!! $errors->first('fech_nacimiento', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
